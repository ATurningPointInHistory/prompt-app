...
(function (global) {
  ...
  async function runSelfDevelopment058Phase5Validation() {
    ...
    check("Phase 5A traceability version matches candidate version", coverage.phase5Version === P5.version && P5.version === "0.5.6", { coverageVersion: coverage.phase5Version, candidateVersion: P5.version }, "Traceability");
    ...
    const report = Object.freeze({
      validationId: namespace.__internal.nextId("SELFDEV058-PHASE5-VALIDATION"), componentId: "SELF-DEVELOPMENT-058", decisionId: "EXTERNAL-010-DECISION-058", version: "0.5.6", phase: 5,
