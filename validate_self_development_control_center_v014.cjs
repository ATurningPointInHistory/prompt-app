...
check("project_info identity matches v0.1.4 source-fallback hotfix candidate",Number(projectInfo.scriptManifestCount)===493&&projectInfo.scriptManifestHash===manifest.manifestHash&&projectInfo.scriptSetHash===manifest.scriptSetHash&&projectInfo.selfDevelopmentControlCenterVersion==="0.1.4"&&projectInfo.selfDevelopmentControlCenterRelevantContextEnrichmentImplemented===true&&projectInfo.selfDevelopmentControlCenterSelectedFileFunctionEnumerationImplemented===true&&projectInfo.selfDevelopmentControlCenterSelectedFileSourceFallbackImplemented===true&&projectInfo.selfDevelopmentControlCenterProjectSearchFallbackImplemented===true&&projectInfo.selfDevelopmentControlCenterArchitectureRelationshipEnrichmentImplemented===true&&projectInfo.selfDevelopmentControlCenterBoundedFunctionArchitectureEvidenceImplemented===true,{count:projectInfo.scriptManifestCount,status:projectInfo.selfDevelopmentControlCenterStatus,version:projectInfo.selfDevelopmentControlCenterVersion});
...
check("Relevant Scope Resolver remains implemented",uiSource.includes('function resolveRelevantScope(')&&uiSource.includes('resolverVersion: "0.1.4"'),null);
