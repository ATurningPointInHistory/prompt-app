...
(function (global) {
  ...
  async function runExternalIntelligencePhase9Validation() {
    ...
    try {
      ...
      check("Gateway remains compatible with Phase baseline (minimum v1.4.0)", VERSION_MANIFEST.isGatewayCompatibleFrom("1.4.0"), VERSION_MANIFEST.gateway.gatewayVersion, "Boundary");
