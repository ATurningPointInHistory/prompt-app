...
(function (global) {
  ...
  async function runExternalIntelligencePhase4Validation() {
    ...
    try {
      ...
      check("Gateway public acquisition endpoint is explicitly versioned", VERSION_MANIFEST.gateway.publicAcquisitionEndpoint === "/v1/acquire/public" && ["1.2.0", "1.3.0", "1.4.0", "1.5.0"].includes(VERSION_MANIFEST.gateway.gatewayVersion), VERSION_MANIFEST.gateway, "Hybrid Routing");
