...
(function (global) {
  ...
  async function runExternalIntelligencePhase4Validation() {
    ...
    try {
      check("Release Version is compatible with Phase 04 baseline", ["1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0"].includes(VERSION_MANIFEST.release.version), VERSION_MANIFEST.release.version, "Foundation");
