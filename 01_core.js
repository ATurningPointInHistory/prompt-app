...
window.scrollRepairTop =
  window.scrollRepairTop || function() {
...
window.scrollRepairBottom =
  window.scrollRepairBottom || function() {
...
window.indentRepairSelection =
  window.indentRepairSelection || function() {

    if (typeof applyRepairIndent === "function") {
      applyRepairIndent(false);
      return;
    }

    alert("applyRepairIndent が未読込です");

  };

window.outdentRepairSelection =
  window.outdentRepairSelection || function() {
