...
(function (global) {
  ...
  function getFoundationState() {
    return {
      ...
      socialObservationCount: state.socialObservations.size,
      socialNarrativeCount: state.socialNarratives.size,
      socialMarketReactionCount: state.socialMarketReactions.size,
      socialInfluenceEvaluationCount: state.socialInfluenceEvaluations.size,
