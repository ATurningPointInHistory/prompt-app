  ...
  const BUILT_IN_SCHEMAS = Object.freeze([
    ...
    schema("EXTERNAL-010-SCHEMA-PHASE2-VALIDATION-RESULT", "External Intelligence Phase 02 Validation Result",
      ["id", "componentId", "version", "implementationPhase", "passed", "failed", "total", "health", "criticalFailed", "status", "releaseAllowed", "phase2Complete", "phase3Allowed", "validatedAt"], {
        id: { type: "string" }, componentId: { type: "string", enum: ["EXTERNAL-010"] }, version: { type: "string", enum: compatibleReleaseEnum(["1.1.0", "1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0"]) }, implementationPhase: { type: "string" },
    ...
    schema("EXTERNAL-010-SCHEMA-PHASE3-VALIDATION-RESULT", "External Intelligence Phase 03 Validation Result",
      ["id", "componentId", "version", "implementationPhase", "decisionCoverage", "passed", "failed", "total", "health", "criticalFailed", "status", "releaseAllowed", "phase3Complete", "phase4Allowed", "validatedAt"], {
        id: { type: "string" }, componentId: { type: "string", enum: ["EXTERNAL-010"] }, version: { type: "string", enum: compatibleReleaseEnum(["1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0"]) }, implementationPhase: { type: "string" }, decisionCoverage: { type: "number", enum: [54] }, passed: { type: "number" }, failed: { type: "number" }, total: { type: "number" }, health: { type: "number" }, criticalFailed: { type: "number" }, status: { type: "string" }, releaseAllowed: { type: "boolean" }, phase3Complete: { type: "boolean" }, phase4Allowed: { type: "boolean" }, validatedAt: { type: "string" }
      }),
    ...
    schema("EXTERNAL-010-SCHEMA-PHASE4-VALIDATION-RESULT", "External Intelligence Phase 04 Validation Result",
      ["id", "componentId", "version", "implementationPhase", "decisionCoverage", "passed", "failed", "total", "health", "criticalFailed", "status", "releaseAllowed", "phase4Complete", "phase5Allowed", "validatedAt"], {
        id: { type: "string" }, componentId: { type: "string", enum: ["EXTERNAL-010"] }, version: { type: "string", enum: compatibleReleaseEnum(["1.3.0", "1.4.0", "1.5.0", "1.6.0", "1.7.0"]) }, implementationPhase: { type: "string" }, decisionCoverage: { type: "number", enum: [54] },
...
,
    ...
    schema("EXTERNAL-010-SCHEMA-PHASE5-VALIDATION-RESULT", "External Intelligence Phase 05 Validation Result", ["id","componentId","version","implementationPhase","decisionCoverage","passed","failed","total","health","criticalFailed","status","releaseAllowed","phase5Complete","phase6Allowed","validatedAt"], {
      id:{type:"string"},componentId:{type:"string",enum:["EXTERNAL-010"]},version:{type:"string",enum:compatibleReleaseEnum(["1.4.0","1.5.0","1.6.0","1.7.0"])},implementationPhase:{type:"string"},decisionCoverage:{type:"number",enum:[54]},passed:{type:"number"},failed:{type:"number"},total:{type:"number"},health:{type:"number"},criticalFailed:{type:"number"},status:{type:"string"},releaseAllowed:{type:"boolean"},phase5Complete:{type:"boolean"},phase6Allowed:{type:"boolean"},validatedAt:{type:"string"}
    }),
    ...
    schema("EXTERNAL-010-SCHEMA-PHASE7-VALIDATION-RESULT", "External Intelligence Phase 07 Validation Result",
      ["id","componentId","version","implementationPhase","decisionCoverage","passed","failed","total","health","criticalFailed","status","releaseAllowed","phase7Complete","phase8Allowed","validatedAt"], {
        id:{type:"string"}, componentId:{type:"string",enum:["EXTERNAL-010"]}, version:{type:"string",enum:compatibleReleaseEnum(["1.6.0","1.7.0"])}, implementationPhase:{type:"string"}, decisionCoverage:{type:"number",enum:[54]}, passed:{type:"number"}, failed:{type:"number"}, total:{type:"number"}, health:{type:"number"}, criticalFailed:{type:"number"}, status:{type:"string"}, releaseAllowed:{type:"boolean"}, phase7Complete:{type:"boolean"}, phase8Allowed:{type:"boolean"}, validatedAt:{type:"string"}
      }),
    ...
    schema("EXTERNAL-010-SCHEMA-PHASE8-VALIDATION-RESULT","External Intelligence Phase 08 Validation Result",["id","componentId","version","implementationPhase","decisionCoverage","passed","failed","total","health","criticalFailed","status","releaseAllowed","phase8Complete","phase9Allowed","validatedAt"],{id:{type:"string"},componentId:{type:"string",enum:["EXTERNAL-010"]},version:{type:"string",enum:compatibleReleaseEnum(["1.7.0"])},implementationPhase:{type:"string"},decisionCoverage:{type:"number",enum:[54]},passed:{type:"number"},failed:{type:"number"},total:{type:"number"},health:{type:"number"},criticalFailed:{type:"number"},status:{type:"string"},releaseAllowed:{type:"boolean"},phase8Complete:{type:"boolean"},phase9Allowed:{type:"boolean"},validatedAt:{type:"string"}}),
    schema("EXTERNAL-010-SCHEMA-TEMPORAL-RELATION-RECORD","External Intelligence Temporal Relation Record",
      ["relationRecordId","relationId","recordVersion","subjectEntityId","relationType","objectEntityId","relationState","supportingEvidenceIds","sourceClaimIds","linkedEventIds","participantResolutionStates","generatedByAI","canonicalRelationConfirmed","relationCandidateEqualsVerifiedRelationship","relationExistenceEqualsCausalImpact","causalImpactGranted","historicalRecordPreserved","createdAt","immutable"],
      {relationRecordId:{type:"string"},relationId:{type:"string"},recordVersion:{type:"number"},subjectEntityId:{type:"string"},relationType:{type:"string"},objectEntityId:{type:"string"},validFrom:{type:["string","null"]},validUntil:{type:["string","null"]},relationState:{type:"string"},supportingEvidenceIds:{type:"array"},sourceClaimIds:{type:"array"},linkedEventIds:{type:"array"},participantResolutionStates:{type:"object"},generatedByAI:{type:"boolean"},createdBy:{type:"string"},resolverId:{type:["string","null"]},resolverVersion:{type:["string","null"]},correctionState:{type:"string"},supersedesRelationRecordId:{type:["string","null"]},canonicalRelationConfirmed:{type:"boolean",enum:[false]},relationCandidateEqualsVerifiedRelationship:{type:"boolean",enum:[false]},relationExistenceEqualsCausalImpact:{type:"boolean",enum:[false]},causalImpactGranted:{type:"boolean",enum:[false]},historicalRecordPreserved:{type:"boolean",enum:[true]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-EVENT-RECORD","External Intelligence Event Record",
      ["eventRecordId","eventId","recordVersion","eventType","participants","participantResolutionStates","locationEntityIds","relationIds","supportingEvidenceIds","sourceClaimIds","eventState","eventSchemaVersion","canonicalEventConfirmed","claimEqualsEventOccurred","announcementEqualsCompletion","planEqualsActualEvent","eventOccurrenceEqualsCausation","historicalRecordPreserved","createdAt","immutable"],
      {eventRecordId:{type:"string"},eventId:{type:"string"},recordVersion:{type:"number"},eventType:{type:"string"},participants:{type:"array"},participantResolutionStates:{type:"object"},locationEntityIds:{type:"array"},relationIds:{type:"array"},supportingEvidenceIds:{type:"array"},sourceClaimIds:{type:"array"},eventTime:{type:["string","null"]},startTime:{type:["string","null"]},endTime:{type:["string","null"]},announcedAt:{type:["string","null"]},plannedAt:{type:["string","null"]},completedAt:{type:["string","null"]},eventState:{type:"string"},correctionType:{type:"string"},supersedesEventRecordId:{type:["string","null"]},eventSchemaVersion:{type:"string"},createdBy:{type:"string"},generatedByAI:{type:"boolean"},canonicalEventConfirmed:{type:"boolean",enum:[false]},claimEqualsEventOccurred:{type:"boolean",enum:[false]},announcementEqualsCompletion:{type:"boolean",enum:[false]},planEqualsActualEvent:{type:"boolean",enum:[false]},eventOccurrenceEqualsCausation:{type:"boolean",enum:[false]},historicalRecordPreserved:{type:"boolean",enum:[true]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-EVENT-STATE-TRANSITION","External Intelligence Event State Transition",
      ["eventStateTransitionId","eventId","fromState","toState","fromEventRecordId","toEventRecordId","supportingEvidenceIds","transitionedAt","historicalEventRewritePerformed","createdAt","immutable"],
      {eventStateTransitionId:{type:"string"},eventId:{type:"string"},fromState:{type:"string"},toState:{type:"string"},fromEventRecordId:{type:"string"},toEventRecordId:{type:"string"},supportingEvidenceIds:{type:"array"},transitionedAt:{type:"string"},historicalEventRewritePerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-IMPACT-EDGE","External Intelligence Impact Edge",
      ["impactEdgeId","fromNodeId","toNodeId","impactType","impactDimension","direction","causalState","lagDistributionHook","supportingEvidenceIds","contradictingEvidenceIds","historicalEvidenceIds","historicalSampleCount","candidateConfounders","modelId","modelVersion","evidenceLineagePreserved","causalTruthConfirmed","correlationEqualsCausation","temporalProximityEqualsCausation","actionAuthorityGranted","financialAuthorityGranted","createdAt","updatedAt","immutable"],
      {impactEdgeId:{type:"string"},fromNodeId:{type:"string"},toNodeId:{type:"string"},fromNodeType:{type:"string"},toNodeType:{type:"string"},impactType:{type:"string"},impactDimension:{type:"string"},direction:{type:"string"},impactStrength:{type:["number","null"]},confidence:{type:["number","null"]},causalState:{type:"string"},earliestLag:{type:["object","null"]},expectedLag:{type:["object","null"]},latestLag:{type:["object","null"]},lagDistributionReference:{type:["string","null"]},lagDistributionHook:{type:"boolean",enum:[true]},impactDuration:{type:["object","null"]},decayModel:{type:["object","null"]},supportingEvidenceIds:{type:"array"},contradictingEvidenceIds:{type:"array"},historicalEvidenceIds:{type:"array"},historicalSampleCount:{type:"number"},candidateConfounders:{type:"array"},modelId:{type:"string"},modelVersion:{type:"string"},evidenceLineagePreserved:{type:"boolean",enum:[true]},causalTruthConfirmed:{type:"boolean",enum:[false]},correlationEqualsCausation:{type:"boolean",enum:[false]},temporalProximityEqualsCausation:{type:"boolean",enum:[false]},actionAuthorityGranted:{type:"boolean",enum:[false]},financialAuthorityGranted:{type:"boolean",enum:[false]},createdAt:{type:"string"},updatedAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-IMPACT-PATH","External Intelligence Impact Path",
      ["impactPathId","edgeIds","stages","pathState","currentStageIndex","pathTiming","modelId","modelVersion","predictionCandidateOnly","canonicalCausalTruthConfirmed","automaticActionPerformed","createdAt","immutable"],
      {impactPathId:{type:"string"},triggerEventId:{type:["string","null"]},edgeIds:{type:"array"},stages:{type:"array"},pathState:{type:"string"},currentStageIndex:{type:"number"},pathTiming:{type:"object"},modelId:{type:"string"},modelVersion:{type:"string"},predictionCandidateOnly:{type:"boolean",enum:[true]},canonicalCausalTruthConfirmed:{type:"boolean",enum:[false]},automaticActionPerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-IMPACT-OBSERVATION","External Intelligence Impact Observation",
      ["impactObservationId","impactPathId","stageIndex","stageState","observedReferenceId","observedAt","supportingEvidenceIds","remainingEdgeIds","remainingLagRecalculationPerformed","finalOutcomeConfirmed","createdAt","immutable"],
      {impactObservationId:{type:"string"},impactPathId:{type:"string"},stageIndex:{type:"number"},stageState:{type:"string"},observedReferenceId:{type:"string"},observedAt:{type:"string"},supportingEvidenceIds:{type:"array"},remainingEdgeIds:{type:"array"},remainingLagRecalculationPerformed:{type:"boolean",enum:[true]},finalOutcomeConfirmed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-HISTORICAL-ANALOG-CANDIDATE","External Intelligence Historical Analog Candidate",
      ["historicalAnalogCandidateId","currentEventId","historicalEventId","similarityDimensions","differenceDimensions","historicalImpactPathIds","outcomeReferences","supportingEvidenceIds","analysisVersion","modelId","modelVersion","historicalAnalogEqualsSameOutcome","automaticPredictionGranted","createdAt","immutable"],
      {historicalAnalogCandidateId:{type:"string"},currentEventId:{type:"string"},historicalEventId:{type:"string"},similarityScore:{type:["number","null"]},similarityDimensions:{type:"array"},differenceDimensions:{type:"array"},historicalImpactPathIds:{type:"array"},outcomeReferences:{type:"array"},supportingEvidenceIds:{type:"array"},analysisVersion:{type:"string"},modelId:{type:"string"},modelVersion:{type:"string"},historicalAnalogEqualsSameOutcome:{type:"boolean",enum:[false]},automaticPredictionGranted:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-SCENARIO-CANDIDATE","External Intelligence Scenario Candidate",
      ["scenarioCandidateId","triggerEventId","impactPathIds","historicalAnalogIds","expectedStages","expectedTiming","expectedDirection","importantAssumptions","riskFactors","contradictingEvidenceIds","modelId","modelVersion","scenarioCandidateEqualsFutureFact","actionAuthorityGranted","financialAuthorityGranted","createdAt","immutable"],
      {scenarioCandidateId:{type:"string"},triggerEventId:{type:"string"},impactPathIds:{type:"array"},historicalAnalogIds:{type:"array"},expectedStages:{type:"array"},expectedTiming:{type:"object"},expectedDirection:{type:"string"},confidence:{type:["string","number"]},importantAssumptions:{type:"array"},riskFactors:{type:"array"},contradictingEvidenceIds:{type:"array"},modelId:{type:"string"},modelVersion:{type:"string"},scenarioCandidateEqualsFutureFact:{type:"boolean",enum:[false]},actionAuthorityGranted:{type:"boolean",enum:[false]},financialAuthorityGranted:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-IMPACT-OUTCOME-EVALUATION-CANDIDATE","External Intelligence Impact Outcome Evaluation Candidate",
      ["impactOutcomeEvaluationCandidateId","impactPathId","actualOutcomeReferenceId","directionAssessment","magnitudeAssessment","timingAssessment","pathAssessment","confidenceAssessment","failedPredictionPreserved","modelRecalibrationCandidate","automaticModelUpdatePerformed","knowledgePromotionPerformed","createdAt","immutable"],
      {impactOutcomeEvaluationCandidateId:{type:"string"},impactPathId:{type:"string"},actualOutcomeReferenceId:{type:"string"},directionAssessment:{type:"string"},magnitudeAssessment:{type:"string"},timingAssessment:{type:"string"},pathAssessment:{type:"string"},confidenceAssessment:{type:"string"},failedPredictionPreserved:{type:"boolean",enum:[true]},modelRecalibrationCandidate:{type:"boolean",enum:[true]},automaticModelUpdatePerformed:{type:"boolean",enum:[false]},knowledgePromotionPerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-PHASE9-VALIDATION-RESULT","External Intelligence Phase 09 Validation Result",
      ["id","componentId","version","implementationPhase","decisionCoverage","passed","failed","total","health","criticalFailed","status","releaseAllowed","phase9Complete","phase10Allowed","validatedAt"],
      {id:{type:"string"},componentId:{type:"string",enum:["EXTERNAL-010"]},version:{type:"string"},implementationPhase:{type:"string"},decisionCoverage:{type:"number",enum:[54]},passed:{type:"number"},failed:{type:"number"},total:{type:"number"},health:{type:"number"},criticalFailed:{type:"number"},status:{type:"string"},releaseAllowed:{type:"boolean"},phase9Complete:{type:"boolean"},phase10Allowed:{type:"boolean"},validatedAt:{type:"string"}}),
    schema("EXTERNAL-010-SCHEMA-RELIABILITY-SIGNAL","External Intelligence Reliability Signal",
      ["reliabilitySignalId","sourceId","observationWindow","requestCount","successCount","timeoutCount","schemaFailureCount","averageLatencyMs","freshnessState","correctionObserved","operationalReliabilityOnly","factualReliabilityDetermined","reliabilityScore","authorityScore","finalReliabilityAuthority","createdAt","immutable"],
      {reliabilitySignalId:{type:"string"},sourceId:{type:"string"},observationWindow:{type:"string"},requestCount:{type:"number"},successCount:{type:"number"},timeoutCount:{type:"number"},schemaFailureCount:{type:"number"},averageLatencyMs:{type:["number","null"]},freshnessState:{type:"string"},correctionObserved:{type:"boolean"},operationalReliabilityOnly:{type:"boolean",enum:[true]},factualReliabilityDetermined:{type:"boolean",enum:[false]},reliabilityScore:{type:"null"},authorityScore:{type:"null"},finalReliabilityAuthority:{type:"string",enum:["EXTERNAL-020"]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-EVIDENCE-QUALITY-SIGNAL","External Intelligence Evidence Quality Signal",
      ["qualitySignalId","evidenceId","sourceId","sourceRole","contentPresent","schemaValid","timestampPresent","sourceIdentityResolved","contentHashVerified","provenanceComplete","temporalMetadataComplete","qualityScore","authorityScore","truthConfirmed","finalReliabilityAuthority","createdAt","immutable"],
      {qualitySignalId:{type:"string"},evidenceId:{type:"string"},sourceId:{type:["string","null"]},sourceRole:{type:"string",enum:["PRIMARY","OFFICIAL","SECONDARY","AGGREGATOR","COMMUNITY","AI_GENERATED","UNKNOWN"]},contentPresent:{type:"boolean"},schemaValid:{type:"boolean"},timestampPresent:{type:"boolean"},sourceIdentityResolved:{type:"boolean"},contentHashVerified:{type:"boolean"},provenanceComplete:{type:"boolean"},temporalMetadataComplete:{type:"boolean"},qualityScore:{type:"null"},authorityScore:{type:"null"},truthConfirmed:{type:"boolean",enum:[false]},finalReliabilityAuthority:{type:"string",enum:["EXTERNAL-020"]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-RELIABILITY-CANDIDATE","External Intelligence Reliability Candidate",
      ["candidateId","candidateType","subjectRef","field","period","evidenceIds","independenceVerified","conflictWinner","truthConfirmed","automaticResolutionPerformed","duplicateEqualsIndependentConfirmation","finalReliabilityAuthority","createdAt","immutable"],
      {candidateId:{type:"string"},candidateType:{type:"string",enum:["CONTRADICTION","CONFIRMATION"]},subjectRef:{type:["string","null"]},field:{type:["string","null"]},period:{type:["string","null"]},evidenceIds:{type:"array"},independenceVerified:{type:"boolean"},conflictWinner:{type:"null"},truthConfirmed:{type:"boolean",enum:[false]},automaticResolutionPerformed:{type:"boolean",enum:[false]},duplicateEqualsIndependentConfirmation:{type:"boolean",enum:[false]},finalReliabilityAuthority:{type:"string",enum:["EXTERNAL-020"]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-RELIABILITY-INPUT-PACKAGE","EXTERNAL-020 Reliability Input Package",
      ["operationalSignals","evidenceQualitySignals","contradictionCandidates","confirmationCandidates","finalReliabilityAuthority","generatedAt"],
      {operationalSignals:{type:"array"},evidenceQualitySignals:{type:"array"},contradictionCandidates:{type:"array"},confirmationCandidates:{type:"array"},finalReliabilityAuthority:{type:"string",enum:["EXTERNAL-020"]},generatedAt:{type:"string"}}),
    schema("EXTERNAL-010-SCHEMA-PREDICTION-RECORD","External Intelligence Prediction Record",
      ["predictionId","version","predictionRecordId","subjectRef","predictionType","targetTime","probabilityState","probability","estimateConfidence","evidenceStrength","historicalSampleCount","predictionInterval","uncertaintyFactors","modelId","modelVersion","evidenceIds","outcomeReference","calibrationState","supersedesPredictionRecordId","probabilityInvented","canonicalTruthConfirmed","actionAuthorityGranted","createdAt","immutable"],
      {predictionId:{type:"string"},version:{type:"number"},predictionRecordId:{type:"string"},subjectRef:{type:["string","null"]},predictionType:{type:"string"},targetTime:{type:["string","null"]},probabilityState:{type:"string",enum:["NOT_ESTIMATED","QUALITATIVE","RANGE","POINT_ESTIMATE","UNKNOWN"]},probability:{type:["number","null"]},estimateConfidence:{type:"string"},evidenceStrength:{type:"string"},historicalSampleCount:{type:["number","null"]},predictionInterval:{type:["object","null"]},uncertaintyFactors:{type:"array"},modelId:{type:["string","null"]},modelVersion:{type:["string","null"]},evidenceIds:{type:"array"},outcomeReference:{type:["string","null"]},calibrationState:{type:"string"},supersedesPredictionRecordId:{type:["string","null"]},probabilityInvented:{type:"boolean",enum:[false]},canonicalTruthConfirmed:{type:"boolean",enum:[false]},actionAuthorityGranted:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-BENCHMARK-DEFINITION","External Intelligence Benchmark Definition",
      ["benchmarkDefinitionId","version","targetMetric","measurementMethod","targetWindow","unit","currency","adjustmentMethod","eventCompletionCriteria","dataSourcePolicy","timezone","supersedesBenchmarkVersion","createdAt","immutable"],
      {benchmarkDefinitionId:{type:"string"},version:{type:"number"},targetMetric:{type:"string"},measurementMethod:{type:"string"},targetWindow:{type:["string","null"]},unit:{type:["string","null"]},currency:{type:["string","null"]},adjustmentMethod:{type:["string","null"]},eventCompletionCriteria:{type:["string","null"]},dataSourcePolicy:{type:["string","null"]},timezone:{type:"string"},supersedesBenchmarkVersion:{type:["number","string","null"]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-OUTCOME-RECORD","External Intelligence Versioned Outcome Record",
      ["outcomeId","version","outcomeRecordId","predictionId","benchmarkDefinitionId","outcomeType","targetEntityId","targetMetric","observationTime","effectiveTime","settlementState","value","unit","currency","supportingEvidenceIds","sourceRole","referenceOutcome","supersedesOutcomeRecordId","absoluteTruthClaimed","historyOverwritePerformed","createdAt","immutable"],
      {outcomeId:{type:"string"},version:{type:"number"},outcomeRecordId:{type:"string"},predictionId:{type:["string","null"]},benchmarkDefinitionId:{type:"string"},outcomeType:{type:"string"},targetEntityId:{type:["string","null"]},targetMetric:{type:["string","null"]},observationTime:{type:["string","null"]},effectiveTime:{type:["string","null"]},settlementState:{type:"string",enum:["NOT_YET_OBSERVED","NOT_YET_AVAILABLE","PARTIALLY_OBSERVED","PRELIMINARY","PROVISIONAL","REVISED","FINAL","DISPUTED","UNRESOLVED","UNMEASURABLE","UNKNOWN"]},unit:{type:["string","null"]},currency:{type:["string","null"]},supportingEvidenceIds:{type:"array"},sourceRole:{type:"string"},referenceOutcome:{type:"boolean"},supersedesOutcomeRecordId:{type:["string","null"]},absoluteTruthClaimed:{type:"boolean",enum:[false]},historyOverwritePerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-OUTCOME-EVALUATION","External Intelligence Outcome Evaluation",
      ["evaluationId","predictionRecordId","referenceOutcomeRecordId","benchmarkDefinitionId","evaluationState","calibrationState","truthAuthorityGranted","automaticActionPerformed","createdAt","immutable"],
      {evaluationId:{type:"string"},predictionRecordId:{type:"string"},referenceOutcomeRecordId:{type:"string"},benchmarkDefinitionId:{type:"string"},evaluationState:{type:"string"},calibrationState:{type:"string"},truthAuthorityGranted:{type:"boolean",enum:[false]},automaticActionPerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}}),
    schema("EXTERNAL-010-SCHEMA-PHASE10-VALIDATION-RESULT","External Intelligence Phase 10 Validation Result",
      ["id","componentId","version","gatewayVersion","implementationPhase","decisionCoverage","passed","failed","total","health","criticalFailed","status","releaseAllowed","phase10Complete","phase11Allowed","checks","validatedAt","immutable"],
      {id:{type:"string"},componentId:{type:"string",enum:["EXTERNAL-010"]},version:{type:"string"},gatewayVersion:{type:"string"},implementationPhase:{type:"string"},decisionCoverage:{type:"number",enum:[54]},passed:{type:"number"},failed:{type:"number"},total:{type:"number"},health:{type:"number"},criticalFailed:{type:"number"},status:{type:"string"},releaseAllowed:{type:"boolean"},phase10Complete:{type:"boolean"},phase11Allowed:{type:"boolean"},checks:{type:"array"},validatedAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-SIGNAL-BASELINE","External Intelligence Signal Baseline",["baselineId","baselineVersion","baselineRecordId","baselineType","referenceWindow","referenceValues","automaticRewritePerformed","createdAt","immutable"],{baselineId:{type:"string"},baselineVersion:{type:"number"},baselineRecordId:{type:"string"},baselineType:{type:"string"},referenceWindow:{type:["string","null"]},referenceValues:{type:"object"},automaticRewritePerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-SIGNAL-RECORD","External Intelligence Signal Candidate",["signalId","signalType","baselineId","baselineVersion","observationRefs","anomalyStrength","novelty","persistence","confidence","signalState","signalEqualsExplanation","actionAuthorityGranted","financialAuthorityGranted","paidResourceAuthorityGranted","createdAt","immutable"],{signalId:{type:"string"},signalType:{type:"string"},baselineId:{type:"string"},baselineVersion:{type:"number"},observationRefs:{type:"array"},anomalyStrength:{type:["number","null"]},novelty:{type:["number","null"]},persistence:{type:["number","null"]},confidence:{type:"string"},signalState:{type:"string"},signalEqualsExplanation:{type:"boolean",enum:[false]},actionAuthorityGranted:{type:"boolean",enum:[false]},financialAuthorityGranted:{type:"boolean",enum:[false]},paidResourceAuthorityGranted:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-SIGNAL-CLUSTER","External Intelligence Signal Cluster",["signalClusterId","memberSignalIds","hypothesis","clusterConfidence","confirmedEvent","createdAt","immutable"],{signalClusterId:{type:"string"},memberSignalIds:{type:"array"},hypothesis:{type:["string","null"]},clusterConfidence:{type:"string"},confirmedEvent:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-RESEARCH-QUESTION","External Intelligence Research Question",["researchQuestionId","researchGoalId","question","triggerSignalIds","relatedEventIds","targetEntityIds","state","createdAt","immutable"],{researchQuestionId:{type:"string"},researchGoalId:{type:["string","null"]},question:{type:"string"},triggerSignalIds:{type:"array"},relatedEventIds:{type:"array"},targetEntityIds:{type:"array"},state:{type:"string"},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-HYPOTHESIS-RECORD","External Intelligence Competing Hypothesis",["hypothesisId","version","hypothesisRecordId","researchQuestionId","hypothesisType","statement","relatedSignalIds","supportingEvidenceIds","contradictingEvidenceIds","missingEvidence","expectedObservations","falsificationCriteria","alternativeHypothesisIds","hypothesisState","confidenceProfile","hypothesisEqualsFact","executionAuthorityGranted","knowledgePromotionPerformed","createdAt","immutable"],{hypothesisId:{type:"string"},version:{type:"number"},hypothesisRecordId:{type:"string"},researchQuestionId:{type:"string"},hypothesisType:{type:"string"},statement:{type:"string"},relatedSignalIds:{type:"array"},supportingEvidenceIds:{type:"array"},contradictingEvidenceIds:{type:"array"},missingEvidence:{type:"array"},expectedObservations:{type:"array"},falsificationCriteria:{type:"array"},alternativeHypothesisIds:{type:"array"},hypothesisState:{type:"string"},confidenceProfile:{type:"object"},hypothesisEqualsFact:{type:"boolean",enum:[false]},executionAuthorityGranted:{type:"boolean",enum:[false]},knowledgePromotionPerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-RESEARCH-PRIORITY","External Intelligence Research Priority Candidate",["researchCandidateId","relatedSignalIds","relatedHypothesisIds","researchState","expectedImpact","urgency","uncertainty","valueOfInformation","researchCost","recommendedAction","explorationExploitation","priorityCandidateOnly","budgetBypassAllowed","financialAuthorityGranted","paidResourceAuthorityGranted","createdAt","immutable"],{researchCandidateId:{type:"string"},relatedSignalIds:{type:"array"},relatedHypothesisIds:{type:"array"},researchState:{type:"string"},expectedImpact:{type:"string"},urgency:{type:"string"},uncertainty:{type:"string"},valueOfInformation:{type:["number","null"]},researchCost:{type:"object"},recommendedAction:{type:"string",enum:["CHEAP_CHECK","MONITOR_SIGNAL","WAIT","STOP","ESCALATE","RESEARCH"]},explorationExploitation:{type:"string",enum:["EXPLORATION","EXPLOITATION","BALANCED","UNKNOWN"]},priorityCandidateOnly:{type:"boolean",enum:[true]},budgetBypassAllowed:{type:"boolean",enum:[false]},financialAuthorityGranted:{type:"boolean",enum:[false]},paidResourceAuthorityGranted:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-WORK-ITEM","External Intelligence Work Item",["workItemId","workItemVersion","workType","goalId","priorityProfile","relatedEntityIds","relatedSignalIds","relatedEvidenceIds","requiredCapabilities","authorityRequirements","resourceEstimate","dependencyIds","correlationId","state","assignmentGrantsAuthority","higherPriorityGrantsAuthority","automaticExecutionGranted","createdAt","immutable"],{workItemId:{type:"string"},workItemVersion:{type:"number"},workType:{type:"string"},goalId:{type:"string"},priorityProfile:{type:"object"},relatedEntityIds:{type:"array"},relatedSignalIds:{type:"array"},relatedEvidenceIds:{type:"array"},requiredCapabilities:{type:"array"},authorityRequirements:{type:"array"},resourceEstimate:{type:"object"},dependencyIds:{type:"array"},correlationId:{type:"string"},state:{type:"string"},assignmentGrantsAuthority:{type:"boolean",enum:[false]},higherPriorityGrantsAuthority:{type:"boolean",enum:[false]},automaticExecutionGranted:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-WORK-GRAPH","External Intelligence Versioned Work Graph",["workGraphId","workGraphVersion","goalIds","rootWorkItemIds","dependencyEdges","priorityState","resourcePlan","supersedesVersion","historicalRewritePerformed","createdAt","immutable"],{workGraphId:{type:"string"},workGraphVersion:{type:"number"},goalIds:{type:"array"},rootWorkItemIds:{type:"array"},dependencyEdges:{type:"array"},priorityState:{type:"string"},resourcePlan:{type:"object"},supersedesVersion:{type:["number","null"]},historicalRewritePerformed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-WORK-ASSIGNMENT","External Intelligence Work Assignment",["assignmentId","workItemId","capabilityId","assignmentState","authorityRevalidationRequired","assignmentGrantsAuthority","createdAt","immutable"],{assignmentId:{type:"string"},workItemId:{type:"string"},capabilityId:{type:["string","null"]},assignmentState:{type:"string"},authorityRevalidationRequired:{type:"boolean",enum:[true]},assignmentGrantsAuthority:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-WORKFLOW-CONFLICT","External Intelligence Workflow Conflict",["conflictId","targetId","candidateActionIds","sourceWorkItemIds","conflictType","severity","resolutionState","majorityVoteGrantsAuthority","resolutionGrantsExecutionAuthority","detectedAt","immutable"],{conflictId:{type:"string"},targetId:{type:"string"},candidateActionIds:{type:"array"},sourceWorkItemIds:{type:"array"},conflictType:{type:"string"},severity:{type:"string"},resolutionState:{type:"string"},majorityVoteGrantsAuthority:{type:"boolean",enum:[false]},resolutionGrantsExecutionAuthority:{type:"boolean",enum:[false]},detectedAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-EMERGENCY-EVENT","External Intelligence Emergency Event",["emergencyEventId","eventType","triggerEventIds","triggerSignalIds","severityProfile","affectedEntityIds","exposurePathIds","evidenceRefs","evidenceState","emergencySignalEqualsTradingAuthority","priorityOverrideMayBypassHardResourceCap","createdAt","immutable"],{emergencyEventId:{type:"string"},eventType:{type:"string"},triggerEventIds:{type:"array"},triggerSignalIds:{type:"array"},severityProfile:{type:"object"},affectedEntityIds:{type:"array"},exposurePathIds:{type:"array"},evidenceRefs:{type:"array"},evidenceState:{type:"string"},emergencySignalEqualsTradingAuthority:{type:"boolean",enum:[false]},priorityOverrideMayBypassHardResourceCap:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-EMERGENCY-DECISION","External Intelligence Emergency Decision",["emergencyDecisionId","decisionVersion","triggerEventIds","triggerSignalIds","affectedEntityIds","exposurePathIds","severityProfile","expectedImpact","timeSensitivity","probabilityState","evidenceStrength","confidence","evidenceRefs","decisionState","revalidationRequired","recommendationOnly","executionAuthorityGranted","financialAuthorityGranted","tradingAuthorityGranted","riskLimitBypassAllowed","resourceHardCapBypassAllowed","createdAt","immutable"],{emergencyDecisionId:{type:"string"},decisionVersion:{type:"number"},triggerEventIds:{type:"array"},triggerSignalIds:{type:"array"},affectedEntityIds:{type:"array"},exposurePathIds:{type:"array"},severityProfile:{type:"object"},expectedImpact:{type:"string"},timeSensitivity:{type:"string"},probabilityState:{type:"string"},evidenceStrength:{type:"string"},confidence:{type:"string"},evidenceRefs:{type:"array"},decisionState:{type:"string"},revalidationRequired:{type:"boolean",enum:[true]},recommendationOnly:{type:"boolean",enum:[true]},executionAuthorityGranted:{type:"boolean",enum:[false]},financialAuthorityGranted:{type:"boolean",enum:[false]},tradingAuthorityGranted:{type:"boolean",enum:[false]},riskLimitBypassAllowed:{type:"boolean",enum:[false]},resourceHardCapBypassAllowed:{type:"boolean",enum:[false]},createdAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-PHASE12-VALIDATION-RESULT","External Intelligence Phase 12 Validation Result",["id","componentId","version","gatewayVersion","implementationPhase","decisionCoverage","passed","failed","total","health","criticalFailed","status","releaseAllowed","phase12Complete","phase13Allowed","checks","validatedAt","immutable"],{id:{type:"string"},componentId:{type:"string",enum:["EXTERNAL-010"]},version:{type:"string"},gatewayVersion:{type:"string"},implementationPhase:{type:"string"},decisionCoverage:{type:"number",enum:[54]},passed:{type:"number"},failed:{type:"number"},total:{type:"number"},health:{type:"number"},criticalFailed:{type:"number"},status:{type:"string"},releaseAllowed:{type:"boolean"},phase12Complete:{type:"boolean"},phase13Allowed:{type:"boolean"},checks:{type:"array"},validatedAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
    ,schema("EXTERNAL-010-SCHEMA-PHASE11-VALIDATION-RESULT","External Intelligence Phase 11 Validation Result",["id","componentId","version","gatewayVersion","implementationPhase","decisionCoverage","passed","failed","total","health","criticalFailed","status","releaseAllowed","phase11Complete","phase12Allowed","checks","validatedAt","immutable"],{id:{type:"string"},componentId:{type:"string",enum:["EXTERNAL-010"]},version:{type:"string"},gatewayVersion:{type:"string"},implementationPhase:{type:"string"},decisionCoverage:{type:"number",enum:[54]},passed:{type:"number"},failed:{type:"number"},total:{type:"number"},health:{type:"number"},criticalFailed:{type:"number"},status:{type:"string"},releaseAllowed:{type:"boolean"},phase11Complete:{type:"boolean"},phase12Allowed:{type:"boolean"},checks:{type:"array"},validatedAt:{type:"string"},immutable:{type:"boolean",enum:[true]}})
  ]);
