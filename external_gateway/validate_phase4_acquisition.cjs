...
async function main() {
  ...
  try {
    ...
    check("Phase 04 Gateway runtime is ready", health.body && ["1.2.0", "1.3.0", "1.4.0", "1.5.0"].includes(health.body.gatewayVersion) && health.body.runtimeState === "READY", JSON.stringify(health.body));
