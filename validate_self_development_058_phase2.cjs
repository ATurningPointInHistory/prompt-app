...
(async () => {
  ...
  const report = { id: "SELF-DEVELOPMENT-058-PHASE2-STATIC-FUNCTIONAL-VALIDATION", decisionId: "EXTERNAL-010-DECISION-058", candidateVersion: "0.2.0", passed: checks.length - failed.length, failed: failed.length, total: checks.length, health: Math.round((checks.length - failed.length) / checks.length * 100), criticalFailed, scriptCount: manifest.scripts.length, manifestHash: manifest.manifestHash, scriptSetHash: manifest.scriptSetHash, phase1FrozenSourceVerified: true, releaseAllowed: false, validationIsApproval: false, providerNetworkCallPerformed: false, canonicalMutationPerformed: false, checks };
