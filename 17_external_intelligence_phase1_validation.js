...
(function (global) {
  ...
  async function runExternalIntelligencePhase1Validation() {
    ...
    check("Release Version is compatible with Phase 01 baseline", ["1.0.0", "1.1.0", "1.2.0", "1.3.0", "1.4.0", "1.5.0", "1.6.0"].includes(VERSION_MANIFEST.release.version), VERSION_MANIFEST.release.version, "Foundation");
