...
(function (global) {
  ...
  const EXPECTED_SCRIPT_COUNT = 199;
  ...
  async function runKnowledgeNavigatorPhase10Validation() {
    ...
    check("Static Script Manifest contains exactly 199 scripts", staticRuntime.scriptCount === EXPECTED_SCRIPT_COUNT, staticRuntime.scriptCount, "Static Integrity", "Critical");
    check("All 199 scripts are fetched on Android", staticRuntime.fetchedScriptCount === EXPECTED_SCRIPT_COUNT && staticRuntime.fetchFailureCount === 0, { fetched: staticRuntime.fetchedScriptCount, failures: staticRuntime.fetchFailureCount }, "Static Integrity", "Critical");
