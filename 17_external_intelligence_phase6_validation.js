...
(function (global) {
  ...
  async function runExternalIntelligencePhase6Validation(){
    ...
    try {
      ...
      check("Implementation Phase is Phase 06",VERSION_MANIFEST.release.phase===6&&VERSION_MANIFEST.release.implementationPhase.indexOf("Phase 06")===0,VERSION_MANIFEST.release.implementationPhase,"Foundation");
